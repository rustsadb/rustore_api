# Contributing to rustore_api gem

### Fork the Project

Fork the [project on Github](https://github.com/rustsadb/rustore_api) and check out your copy.

```
git clone https://github.com/contributor/rustore_api.git
cd rustore_api
git remote add upstream https://github.com/rustsadb/rustore_api.git
```

### Bundle Install

Ensure that you can build the project
...
Go to https://github.com/contributor/rustore_api and select your feature branch. Click the 'Pull Request' button and fill out the form. Pull requests are usually reviewed within a few days.
...
```
* [#123](https://github.com/rustsadb/rustore_api/pull/123): Reticulated splines - [@contributor](https://github.com/contributor).
```
